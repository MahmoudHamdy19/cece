...
class ClosingCeremonyContent extends GetWidget<OrganizerCreateNewProjectController>{
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            createNewProjectTabs(controller,context,'Closing Ceremony'),
             const SizedBox(
              height: 16,
            ),
            Row(
                ...
                Expanded(
                  child: InkWell(
                    onTap: () async {
                      ...
                      if (picked != null)
                        controller.closingEndDateController.text =
                            DateFormat('yyyy-MM-dd').format(picked);
                    },
                    child: DefaultFormField(
                      controller: controller.closingEndDateController,
                      labelText: "endDate",
                      title: 'End Date',
                      prefixIcon: Icons.date_range_outlined,
                      enabled: false,
