...
class RegistrationCeremonyContent extends GetWidget<OrganizerUpdateProjectController> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            updateProjectTabs(controller, context, 'Registration Ceremony'),
                  ...
                  child: InkWell(
                    onTap: () async {
                      final DateTime? picked = await showDatePicker(
                        context: context,
                        initialDate: DateTime.tryParse(controller.registrationStartDateController.text),
