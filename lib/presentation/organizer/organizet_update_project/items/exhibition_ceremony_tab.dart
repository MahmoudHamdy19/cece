...
class ExhibitionDetails extends GetWidget<OrganizerUpdateProjectController>{
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            updateProjectTabs(controller, context, 'Exhibition Details'),
            const SizedBox(
              height: 16,
            ),
            Row(
                ...
                Expanded(
                  child: InkWell(
                    onTap: () async {
                      final DateTime? picked = await showDatePicker(
                        context: context,
                        initialDate: DateTime.tryParse(controller.exhibitionEndDateController.text)??controller.startDate.value!,
                        firstDate: controller.startDate.value!,
                        lastDate: controller.endDate.value!,
                      );
                      if (picked != null)
