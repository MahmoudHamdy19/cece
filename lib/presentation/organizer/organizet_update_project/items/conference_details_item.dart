...
class ConferenceDetailsWidget extends GetWidget<OrganizerUpdateProjectController> {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                updateProjectTabs(controller, context, "Conference Details"),
                ...
                SizedBox(height: 10.0,) ,
               Visibility(
                    visible: controller.conference.conferenceDetails?.image != null,
                    child: SizedBox(
                      height: 250,
                      child: Center(
                        child: ClipRRect(
                           child:ImageNetwork(
                            image: controller.conference.conferenceDetails!.image!,
                            height: 250,
                            width: 250,
                            duration: 1500,
                            curve: Curves.easeIn,
...
updateProjectTabs(controller,context,String title)=>Row(
