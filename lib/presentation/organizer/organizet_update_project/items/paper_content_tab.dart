...
class PaperContent extends GetWidget<OrganizerUpdateProjectController> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Obx(
          ()=> Column(
            children: [
              updateProjectTabs(controller, context, 'Paper Session'),
              SizedBox(
                ...
                child: DataTable(
                  ...
                  rows: controller.paperModel.map((element) {
                    var collaborator =  controller.authors.firstWhere((e) => e.id == element.id,orElse: () => CollaboratorModel(),);
