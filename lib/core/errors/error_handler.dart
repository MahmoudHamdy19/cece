...
class ErrorHandler implements Exception {
 ...
 extension DataSourceString on DataSource {
   String getString() {
     switch (this) {
       ...
       case DataSource.CONFERENCE_EXIST:
         return '1001' ;
     }
   }
 }
 ...
 extension FirebaseArabicErrorMessage on FirebaseException {
   Failure getArabicMessage() {
     switch (code) {
       ...
       case '1001':
         return DataSource.CONFERENCE_EXIST.getFailure();
       default:
 ...
 extension DataSourceExtension on DataSource {
   Failure getFailure() {
     switch (this) {
       ...
       case DataSource.CONFERENCE_EXIST:
         return Failure(ResponseCode.CONFERENCE_EXIST.toString(), ResponseMessage.CONFERENCE_EXIST);
     }
   }
 }
 class ResponseCode {
   ...
   static const int CONFERENCE_EXIST = 1001;
 }
 ...
 class ResponseMessage {
   ...
   static const String CONFERENCE_EXIST = "Conference already exist";
 }
