...
class WorkshopDetails extends StatelessWidget {
  ...
  WorkshopDetails(this.conference);

  @override
  Widget build(BuildContext context) {
    var activities = conference?.workshopList;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomWidgetDisplay(
                            ...
                            date:  conference?.presenters?[int.parse(activities?[index].presenter??'0')].firstName??''),
                        const SizedBox(
                          height: 10,
                        ),
                        ...
                        CustomWidgetDisplay(
                            ...
                            label: "Workshop Hall", date:  activities?[index].hall??''),],),
                  ),
                );
              },)
          ],
