...
class PanelDiscussionsDetails extends StatelessWidget {
  OrganizerEvents? conference;

  PanelDiscussionsDetails(this.conference);


  @override
  Widget build(BuildContext context) {
    var activities = conference?.panelList;
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 10,),
                              Text(activities?[index].topic ?? '', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0),),
                            ],
                          ),
                        ),
                        const SizedBox(
                        ...
                        CustomWidgetDisplay(
                          ...
                          date: conference?.moderators?[int.parse(activities?[index].moderatorProfile??'0')].firstName ?? '',
                        ),
                        const SizedBox(
                          height: 10,
                        ),
                        CustomWidgetDisplay(
                          ...
                          date:  conference?.participants?[int.parse(activities?[index].participantProfile??'0')].firstName ?? '',
                        ),
                        const SizedBox(
                          height: 10,
                        ),
